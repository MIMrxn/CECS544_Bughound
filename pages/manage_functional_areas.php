...
<html>
    ...
    <body>
        ...
        <div class="vertical-menu">
            ...
            <a href="edit_functional_area.php">Edit a functional area's information</a>
            <a href="delete_functional_area.php">Delete a functional area</a>
            <a href="search_functional_areas.php">Search for a functional area</a>         
        </div>
