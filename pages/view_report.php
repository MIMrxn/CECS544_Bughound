        ...
        <form name="update_report_form" action="update_report_post.php?report_id=<?php echo $report_id; ?>" method="post" onsubmit="return validate(this)">
            <table>
                <tr>
                    ...
                    <td>Report Type:</td>
                    <td>
                        <select name="report_type" disabled>
            ...
            <table>
                <tr>
                    ...
                    <td><input type="Text" name="summary" size="60" value="<?php echo $summary; ?>" readonly></td>
                    <td>Reproducible?</td>
                    <?php
                        if($reproducible === "1") {
                            echo '<td><input type="checkbox" name="reproducible" value="checked" checked disabled></td>';
                        } else {
                            echo '<td><input type="checkbox" name="reproducible" value="checked" disabled></td>';
                        }
                    ?>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea name="problem_description" rows="5" cols="50" placeholder="Explain why bug is a problem. Describe all steps and symptoms including error messages. Be careful to describe how to reproduce the problem. Even if you can’t reproduce it, describe all the steps taken to do so." readonly><?php echo $problem_description; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>Suggested Fix:</td>
                    <td><textarea name="suggested_fix" rows="5" cols="50" placeholder="(OPTIONAL)" readonly><?php echo $suggested_fix; ?></textarea></td>
                </tr>
            </table>
            <table>
                <tr>
                    <td>Reported By:</td>
                    <td>
                        <select name="reported_by" disabled>
                    ...
                    <td><input  type="date" name="date_discovered" value="<?php echo $date_discovered; ?>" readonly></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td><input type="Text" name="resolution_version" size="15" value="<?php echo $resolution_version; ?>" readonly></td>
                </tr>
            </table>
            <table>
                <tr>
                    <td>Resolved By:</td>
                    <td>
                        <select name="resolved_by" disabled>
                    ...
                    <td>Date Resolved:</td>
                    <td><input  type="date" name="date_resolved" value="<?php echo $date_resolved; ?>" readonly></td>
                    <td>Tested By:</td>
                    <td>
                        <select name="tested_by" disabled>
                    ...
                    <td>Date Tested:</td>
                    <td><input  type="date" name="date_tested" value="<?php echo $date_tested; ?>" readonly></td>
                    <td>Treat as deferred?</td>
                    <?php
                        if($treat_deferred === "1") {
                            echo '<td><input type="checkbox" name="treat_deferred" value="checked" checked disabled></td>';
                        } else {
                            echo '<td><input type="checkbox" name="treat_deferred" value="checked" disabled></td>';
                        }
                    ?>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    ...
                    <td><textarea name="comments" rows="5" cols="50" placeholder="Add any extra information that may be relevant." readonly><?php echo $comments; ?></textarea></td>
                </tr>
                <tr>
                    <td>Attachments:</td>
                    <?php
