...
<html>
    ...
    <body>
        ...
        <form name="edit_employee_form" action="edit_employee_post.php" method="post" onsubmit="return validate(this)">
            <table>
            ...
            <input class="button" type="button" onclick="window.location.replace('edit_employee.php')" value="Cancel" />
        </form>
